...
from tkinter import simpledialog #module for taking user input via pop-up dialogs.
import tkinter
import numpy as np
...
global filename # A variable to store the name or path of the dataset file selected or used in the application.
...
def graph():
    ...
    df.pivot_table(index="Algorithms",columns="Performance Output",values="Value").plot(kind='bar')
    plt.show()
